...
namespace argus_monitor {
	namespace data_api {
		...
		public:
			ArgusMonitorDataAccessor() : ArgusMonitorDataAccessor(100U) {}
			ArgusMonitorDataAccessor(const DWORD polling_interval) : polling_interval(polling_interval) {}
